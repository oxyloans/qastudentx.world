...
export default function Recuterregister() {       
...
{/*                 
                ...
                <div class="form-group col-md-5 marlefor">
                  ...
                  <div class="form-group col-md-11">
                    ...
                    <input className="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1"  onChange={(e) => setgender(e.target.value)}/>
